...
<form action="<?php echo JRoute::_('index.php?option=com_carshopping&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="dealer-form" class="form-validate">

    <div class="form-horizontal">
        <?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

        <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_CARSHOPPING_TITLE_DEALER', true)); ?>
        <div class="row-fluid">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('showroom_name'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('showroom_name'); ?></div>
			</div>
