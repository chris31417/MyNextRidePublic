 ...
 */
class CarshoppingViewCustomers extends JViewLegacy {
    ...
    public function display($tpl = null) {		
        ...
        CarshoppingHelper::addSubmenu('customers');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CARSHOPPING_TITLE_CUSTOMERS'), 'customers.png');
        ...
        if ($canDo->get('core.edit.state')) {
            ...
            if (isset($this->items[0]->state)) {
                ...
                JToolBarHelper::deleteList('', 'customers.delete', 'Delete User');
            }
        ...
        if (isset($this->items[0]->state)) {
            if ($state->get('filter.state') == -2 && $canDo->get('core.delete')) {
                ...
                JToolBarHelper::trash('customers.deleteadvisor', 'JTOOLBAR_TRASH');
                JToolBarHelper::divider();
            }
        }
        ...
        JHtmlSidebar::setAction('index.php?option=com_carshopping&view=customers');
