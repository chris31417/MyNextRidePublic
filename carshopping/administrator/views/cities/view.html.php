 ...
 */
class CarshoppingViewCities extends JViewLegacy {
    ...
    public function display($tpl = null) {		
        ...
        CarshoppingHelper::addSubmenu('cities');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CARSHOPPING_TITLE_CITIES'), 'cities.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_carshopping&view=cities');
