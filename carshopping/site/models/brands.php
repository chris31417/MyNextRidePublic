 ...
 */
class CarshoppingModelBrands extends JModelList
{

	const TABLE = '#__carshopping_brand';
    /**
     * Constructor.
     *
    ...
    protected function getListQuery()
    {
        ...
        $query->from('`#__carshopping_brand` AS a');
...
$query->where('a.state = 1');
	...
	/**
	 * get all brands
	 * @return array of record [id,brand_name]
	 */
    public function getItems()
    {
		...
		$query = $db->getQuery(TRUE);
		$query->select('*');
		$query->from($db->quoteName('#__carshopping_brand'));		
