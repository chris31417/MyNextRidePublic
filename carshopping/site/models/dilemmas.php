...
class CarshoppingModelDilemmas extends JModelList
{
	...
	const TABLE = '#__carshopping_dilemma';
    /**
     * Constructor.
     *
...
$query->where('a.state = 1');
	...
	/**
	 * get all dilemma options
	 * @return array of record [id,title,tooltip]
	 */
	...
	public function getItemByUserId($userid){
		...
		$query = $db->getQuery(TRUE);
		$query->select('*');
		$query->from($db->quoteName('#__carshopping_dilemma'));
	...
	public function save($obj){
		if(empty($obj->id)){
			...
			$result = JFactory::getDbo()->insertObject('#__carshopping_dilemma', $obj);
		}else{
			$result = JFactory::getDbo()->updateObject('#__carshopping_dilemma', $obj, 'id');
		}
		return $result;
	}	
