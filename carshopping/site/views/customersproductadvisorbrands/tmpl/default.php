...
?>
<h2>Product Advisor List - by brand</h2>
<form >
<table>
		<tr>
			<td>Filter:</td>
			<td>
			<?php 
				$dropdown = JHTML::_('select.genericlist', $this->ddlbrands, 'brand_id', 'onchange="this.form.submit()" class="inputbox required"', 'value', 'text', $this->brand_id);
				echo $dropdown;
...
<?php if(count($this->productAdvisors)==0):?>
	<p>There is no Product Advisor. Please select a brand from dropdown above</p>
<?php else:?>
