...
?>
<h2>Dealer's Pending Product Advisors</h2>
...
<table border="1" cellpadding="10">
	...
	<tbody>
		...
		<tr>
			...
			<td>				
				<a href="<?php echo JRoute::_('index.php?option=com_carshopping&view=dealerspendingproductadvisor&layout=edit&id='.$pa->created_by);?>">Approve</a>
			</td>
		</tr>
		<?php endforeach;?>
	</tbody>
