...
<?php if ($params->get('show_search')){?>
	...
	<div class="search_button_vehicle basictable_47 basictable">
		<?php
		$link = 'index.php?option=' . $option . '&amp;task=show_search_vehicle&amp;catid=' . $catid . '&amp;Itemid=' . $Itemid;
		?> 
...
<?php positions_vm($params->get('singlecategory05')); ?>
                 <div id="gallery">
                    ...
                    if ($option != "com_vehiclemanager") {
                      $link = 'index.php?option=' . $option . '&task=view_vehicle&tab=getmyvehiclesTab&is_show_data=1&id=' . $row->id . '&catid=' . $row->catid . '&Itemid=' . $Itemid . '#tabs-2';
                    } else {
                        $link= 'index.php?option=' . $option . '&amp;task=view_vehicle&amp;id=' . $row->id . '&amp;catid=' . $row->catid . '&amp;Itemid=' . $Itemid;
                    }
