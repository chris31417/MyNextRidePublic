...
**/
    ...
    global $hide_js, $Itemid, $mainframe, $mosConfig_live_site, $vehiclemanager_configuration, $doc;
    ...
    <form action="<?php echo sefRelToAbs($path); //JRoute::_($path);?>" method="get" name="userForm1" id="userForm1">
		...
		<div class="col_07_08">
	      ...
	      <script type="text/javascript"> 
               ...
               jQuerVEH(function() {
		  jQuerVEH("#slider1").slider({ 
		      min: <?php echo $params->get('yearfrom'); ?>,
		      max: <?php echo $params->get('yearto'); ?>,
		      values: [<?php echo $params->get('yearfrom'); ?>,<?php echo $params->get('yearto'); ?>],
		      range: true,
		      stop: function(event, ui) {
			  jQuerVEH("input#yearlist").val(jQuerVEH("#slider1").slider("values",0));
			  jQuerVEH("input#yearlistto").val(jQuerVEH("#slider1").slider("values",1));
		      },
		  ...
		  jQuerVEH("input#yearlist").change(function(){
			      var value1=jQuerVEH("input#yearlist").val();
			      var value2=jQuerVEH("input#yearlistto").val();
			  
			      if(parseInt(value1) > parseInt(value2)){
				  value1 = value2;
				  jQuerVEH("input#yearlist").val(value1);
			      }
			      jQuerVEH("#slider1").slider("values",0,value1);   
			  });
			      
			  jQuerVEH("input#yearlistto").change(function(){
			      var value1=jQuerVEH("input#yearlist").val();
			      var value2=jQuerVEH("input#yearlistto").val();
			      
			      if (value2 > <?php echo $params->get('yearto'); ?>) { value2 = <?php echo $params->get('yearto'); ?>; jQuerVEH("input#yearlistto").val(<?php echo $params->get('yearto'); ?>)}
			  
			      if(parseInt(value1) > parseInt(value2)){
				  value2 = value1;
				  jQuerVEH("input#yearlistto").val(value2);
			      }
			      jQuerVEH("#slider1").slider("values",1,value2);
			  });
		  });
		...
		<span class="col_01"><?php echo _VEHICLE_MANAGER_LABEL_YEAR;?></span>
		    <div class="inp_label_from">
		      ...
		      <input type="text" id="yearlist" value="<?php echo $params->get('yearfrom'); ?>"/>
		    </div>
		    <div class="inp_label_from">
			<span class="col_03"><?php echo _VEHICLE_MANAGER_LABEL_PRICE_TO;?></span>
			<input type="text" id="yearlistto" value="<?php echo $params->get('yearto'); ?>"/>
		    </div>
		  <div class="slider_price">
		      <div id="slider1" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"></div>
		  </div>
            </div>
        ...
        <div class="row_02">
            ...
            <script type="text/javascript">
                      ...
                      for($c=0; $c<count($makers); $c++){
                         $makers[$c]='\''.$makers[$c].'\'';
                         foreach($models[$c] as $temp=>$model) $models[$c][$temp]='\''.$model.'\'';
